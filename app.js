...
function renderCalendar() {
  const year = currentMonth >= planningSeason.startMonth ? planningSeason.startYear : planningSeason.startYear + 1; const daysInMonth = new Date(year, currentMonth + 1, 0).getDate();
